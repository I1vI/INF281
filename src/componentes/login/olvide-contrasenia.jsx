        ...
        <div className="flex items-center justify-center min-h-screen text-white">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <p className="text-black text-sm text-center mb-6">
                    Introduce tu dirección de correo electrónico. Te enviaremos un e-mail con un enlace para restablecer tu contraseña.
                </p>
                ...
                {emailEnviado ? (
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input 
                            ...
                            {...register("email", { required: "El correo es obligatorio", pattern: { value: /^[^@]+@[^@]+\.[a-zA-Z]{2,}$/, message: "Correo inválido" } })}
                        />
